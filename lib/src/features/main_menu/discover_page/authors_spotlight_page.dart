            ...
            itemBuilder: (_, index){
              ...
              return Card(
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_)=> AboutAuthorPage(author: author)));
                  },
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: CachedNetworkImageProvider(author.books.first.image),
                        ),
